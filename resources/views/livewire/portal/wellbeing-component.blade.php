<div>
    <h1 class="h3 mb-4">Cómo me siento</h1>
    ...
    @else
        ...
        <form wire:submit="save">
            ...
            @else
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        <h2 class="h5 mb-3">Ánimo (últimas 2 semanas)</h2>
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        <h2 class="h5 mb-3">Experiencias en la UCI</h2>
            ...
            <button type="submit" class="btn btn-posuci btn-lg">Enviar</button>
        </form>
    @endif
</div>
